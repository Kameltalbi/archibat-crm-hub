...
import {
  ...
  LineChart,
  Wallet,
  Archive, // Replacing Categories with Archive which is available in lucide-react
} from "lucide-react";
...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { id: 12, title: "Catégories dépenses", icon: <Archive size={18} />, path: "/dashboard/expense-categories" },
